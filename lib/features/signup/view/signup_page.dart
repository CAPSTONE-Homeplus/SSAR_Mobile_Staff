...
import 'package:home_staff/features/signup/controllers/signup_controller.dart';
import 'package:home_staff/helpers/helper_extensions.dart';
import 'package:home_staff/helpers/snackbar_helper.dart';
import 'package:home_staff/infra/auth/service/auth_result_handler.dart';
import 'package:home_staff/infra/traveler/repository/traveler_exceptions.dart';
                      ...
                      Column(
                        children: [
                          ...
                          _buildFormField(formState, 'password', context.localization.password, [
                            FormBuilderValidators.required(),
                            FormBuilderValidators.match(AppConstants.passwordRegex.pattern as RegExp),
                          ]),
                          const SizedBox(height: 24),
